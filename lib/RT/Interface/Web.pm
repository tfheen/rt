...
sub WebRemoteUserAutocreateInfo {
    ...
    if ( !$RT::WebRemoteUserAutocreateDefaults
        || ( ref($RT::WebRemoteUserAutocreateDefaults) && not exists $RT::WebRemoteUserAutocreateDefaults->{Privileged} ) )
    {
        ...
        and (not _UserLoggedIn() or $logged_in_external_user) )
    {
        ...
        if ( RT->Config->Get('WebRemoteUserAutocreate') and not _UserLoggedIn() ) {
            ...
            my ( $val, $msg ) = $UserObj->Create(
                %{ ref RT->Config->Get('WebRemoteUserAutocreateDefaults') ? RT->Config->Get('WebRemoteUserAutocreateDefaults') : {} },
                Name  => $user,
                Gecos => $user,
            );
            ...
            if ($val) {
                ...
                AbortExternalAuth( Error => "WebRemoteUserAutocreateDefaults" );
            }
        }
